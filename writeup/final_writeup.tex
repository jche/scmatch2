...
\note{A helpful feature: figure out which covariates are causing the most data to drop. Simple approach: marginal grid for each covariate, count number of feasible tx units and total number of matched controls}
...
We consider the subsample of experimental treated units used in \citet{dehejia1999causal} and control units from the full Current Population Survey file, leading to a total of 185 treated and asdf control units.
...
Figures asdf and asdf assess the estimate-estimand tradeoff.
For the chosen caliper, 145 of the 185 treated units in the data
