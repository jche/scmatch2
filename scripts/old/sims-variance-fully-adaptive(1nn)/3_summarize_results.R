# scripts/sims-variance-fully-adaptive(1nn)/3_summarize_results.R
#!/usr/bin/env Rscript
...
# input
in_csv <- here::here("data/outputs/sims-variance-fully-adaptive(1nn)/combined_results.csv")

# output dir
out_dir <- here::here("tables/sims-variance-fully-adaptive(1nn)")
...
for (m in methods) {
  ...
  out_csv <- file.path(out_dir, paste0("table_", m, ".csv"))
