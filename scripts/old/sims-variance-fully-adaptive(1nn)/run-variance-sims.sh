#!/bin/bash
#SBATCH -J csm_infer
#SBATCH -o logs/csm_infer_%A_%a.out
#SBATCH -e logs/csm_infer_%A_%a.err
#SBATCH -c 16
#SBATCH --mem=24G
#SBATCH -t 02:00:00
#SBATCH --array=1-1000
...
r_script_path="${project_dir}/scripts/sims-variance-fully-adaptive(1nn)/1_parallel_sim_inference.R"
