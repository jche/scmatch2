...
#   Rscript scripts/sims-bias_mse-no-filter-unmatched/demo_run_single_iter_fast.R
#   Rscript scripts/sims-bias_mse-no-filter-unmatched/demo_run_single_iter_fast.R hainmueller 1 "diff,bal1,ps_lm"
#   Rscript scripts/sims-bias_mse-no-filter-unmatched/demo_run_single_iter_fast.R toy 3 diff bal1 or_lm ps_lm
...
runner <- "scripts/sims-bias_mse-no-filter-unmatched/run_single_iteration.R"
...
out_file <- file.path("data", "outputs", "sims-bias_mse-no-filter-unmatched", sim, sprintf("iter_%04d.csv", id))
