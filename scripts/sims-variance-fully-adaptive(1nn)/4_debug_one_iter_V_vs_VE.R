...
# scripts/sims-variance-fully-adaptive(1nn)/4_debug_one_iter_V_vs_VE.R
#
# Usage:
#   Rscript scripts/sims-variance-fully-adaptive(1nn)/4_debug_one_iter_V_vs_VE.R 1 very_low homoskedastic
#
# What it does:
...
devtools::load_all()
source(here::here("scripts/sims-variance-fully-adaptive(1nn)/0_sim_inference_utils.R"))
