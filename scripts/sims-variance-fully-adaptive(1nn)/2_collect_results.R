# scripts/sims-variance-fully-adaptive(1nn)/2_collect_results.R
#!/usr/bin/env Rscript
...
paths <- list(
  out_base = here::here("data/outputs/sims-variance-fully-adaptive(1nn)"),
  individual_dir = here::here("data/outputs/sims-variance-fully-adaptive(1nn)/individual"),
  combined_csv = here::here("data/outputs/sims-variance-fully-adaptive(1nn)/combined_results.csv"),
  combined_rds = here::here("data/outputs/sims-variance-fully-adaptive(1nn)/combined_results.rds")
)
